...
$(function(){
    var numberOfItems = $(".cnt-page .box-style").length;

    
     var limitPerPage = 2;//how many card items visble per page.
     var totalPages = Math.ceil(numberOfItems / limitPerPage);
     var paginationSize = 7; //how many page-elements visble in pagination.
     var currentPage;
    ...
    if(totalPages != 1) {
     ...
     function showPage(whichPage) {
         ...
         $(".cnt-page .box-style").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();
